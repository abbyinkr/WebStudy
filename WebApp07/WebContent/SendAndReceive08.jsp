...
<%
	// 달력 객체 생성 
	//-- Calendar는 인터페이스로, getInstance() 메소드를 통해 객체를 생성한다.
	...
	// 최초 요청이 아닐 경우 클라이언트에게 넘겨받은 연도, 월로 year, month 에 담기
	if(strYear != null)
...
<div>
	...
	<table style="text-align: center;">
		...
		// out.print("~~~") 는 파라미터로 설정된 string을 '클라이언트'(브라우저)에게 보내는 기능
		out.print("<tr>");
		...
		{
			// 일요일이면 red, 토요일이면 blue, 평일은 white
