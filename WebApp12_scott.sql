...
, CONSTRAINT MEMBERSCORE_KOR_PK CHECK(KOR BETWEEN 0 AND 100)
, CONSTRAINT MEMBERSCORE_ENG_PK CHECK(ENG BETWEEN 0 AND 100)
, CONSTRAINT MEMBERSCORE_MAT_PK CHECK(MAT BETWEEN 0 AND 100)
