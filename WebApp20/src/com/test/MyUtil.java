...
// 다양한 방법들 중 한가지(그나마 쉬운 것)이다.
// 학습을 마친 후에... 꼭 추가적으로 개념을 정리하고 
// 확장시키고, 다른방법들도 찾아보고 공부해야 한다.
...
public class MyUtil
{
	...
	public String pageIndexList(int currentPage, int totalPage, String listUrl)
	{
		...
		int numPerBlock = 10;
		//-- 페이징 처리시 게시물 리스트 하단의 숫자를 10개씩 보여주겠다.
		...
		// 페이징 요청을 처리하는 과정에서
		// URL 경로의 패턴에 대한 처리 -- 후에 [검색기능] 를 결합하기 위한 처리
		/*
		...
		*/
		...
		while( (page<=totalPage) && (page<=currentPageSetup + numPerBlock))
		{
			...
			//else
				strList.append(" <a href='" + listUrl + "pageNum=" + page + "'>" + "</a>");
