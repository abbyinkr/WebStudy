...
<%
	...
	//-- getContextPath() : 서블릿 컨테이너 안에서 자원들이 관리되는 경로를 얻겠다.
...
<%
	...
	{
		// request.getMethod() : GET / POST 인지 알 수 있다.
		// String.equalsIgnoreCase("GET") : 대소문자 구별없이 GET과 같다면
		// 넘어온 값이 GET 방식이라면...
	...
	int numPerPage = 10;			//-- 한 페이지에 표시할 데이터 갯수 (게시물 수)
