...
%>
<%
	// 수정 액션 요청시 넘어온 게시물 번호 및 페이지 번호 데이터 수신
	...
	<form action="" method="post" name="myForm">
		<div id="bbsCreated">
			...
			<div id="bbsCreated_content">
				<dl>
					...
					<dd>
						...
						<%-- textarea는 태그 사이에 내용을 넣어준다 
							 \n 개행을 <br> 태그로 바꾸지않아도 된다.
						     여는태그와 닫는 태그가 한줄에 있어야 한다.--%>
					</dd>
				</dl>
			...
			<div id="bbsCreated_footer">
				...
				<!-- hidden Element 로 num, pageNum 값 Updated_ok.jsp 전송 -->
