...
<script type="text/javascript">
	function sum()
	{
		...
		// 『"GET"』 : 요청방식(POST 사용가능, POST 사용시 헤더 추가)
		// 『url』 : AJAX 요청페이지(데이터 수신 및 응답 페이지)
		// 『true』 : boolean → true(비동기), false(동기). 동기는 사용안함 처리됨.
		...
		// GET 방식으로 데이터를 전송하는 경우... 인자값을 "" 으로 구성할 것
		// POST 방식으로 데이터를 전송하는 경우... 인자값에 데이터를 넣는다.
		// 현재는 GET 방식의 요청이다. (send()의 매개변수를 비워두는 것은 하지 말자.)
		ajax.send("");
