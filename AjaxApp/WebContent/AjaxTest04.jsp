...
<script type="text/javascript">
	...
	function callBack2()
	{
		...
		// 검색 결과가 존재하는 경우.. 반복문을 돌며 각 데이터 가져오기
...
<table class="table">
	<tr>
		<th>아이디</th>
		<td>
			<input type="text" class="control" id="id">
			<input type="button" class="control" value="중복검사" onclick="check()">
			<span id="result"></span>
	...
	<tr>
		<th>주소</th>
		<td>
			<input type="text" class="control" id="addr" placeholder="동 입력">
	...
	<tr>
		<th>전화</th>
		<td>
			<input type="text" class="control" id="tel">
		</td>
	</tr>
